...
//															layout.beforeLayout = function(
//																	width,
//																	height) {
//																return this
//																		.previousBeforeLayout()
//																		|| !this.owner.preventMark;
//															};
...
//																			&& owner.changed) {
//																		errorEl
//																				.removeCls('owf-form-valid-field');
//																		errorEl
//																				.removeCls('x-form-warning-icon');
//																		errorEl
//																				.removeCls('owf-form-unchanged-field');
//																		errorEl
//																				.addCls(Ext.baseCSSPrefix
//																						+ 'form-invalid-icon');
//																		layout.tip = layout.tip ? layout.tip
//																				: Ext
//																						.create(
//																								'Ext.tip.QuickTip',
//																								{
...
//																				.setDisplayed(owner
//																						.hasActiveError());
//																	} else if (owner.hasActiveWarning
//																			&& owner
//																					.hasActiveWarning()
//																			&& owner.changed) {
//																		errorEl
//																				.removeCls(Ext.baseCSSPrefix
//																						+ 'form-invalid-icon');
//																		errorEl
//																				.removeCls('owf-form-valid-field');
//																		errorEl
...
//																	}
//																},
//																adjustHorizInsets : function(
//																		owner,
//																		info) {
//																	if (owner.autoFitErrors) {
//																		info.insets.right += owner.errorEl
//																				.getWidth();
//																	}
//																},
//																adjustVertInsets : Ext.emptyFn,
//																layoutHoriz : function(
//																		owner,
//																		info) {
//																	owner.errorEl
//																			.setStyle(
...
//													submitValue : true,
//													preventMark : true,
//													checked : (me.send != undefined) ? me.send
//															: true
//												}, {
//													xtype : 'checkbox',
//													name : 'receive',
...
//															this.submitValues['original'
//																	+ fields[field].name
//																			.charAt(
//																					0)
//																			.toUpperCase()
//																	+ fields[field].name
//																			.slice(1)] = fields[field].originalValue;
//														if (fields[field].xtype == 'textfield'
//																&& fields[field]
//																		.getValue() == '')
//															blankField = true;
//													}
...
//
//		var sendChk = this.down('#sendChk'), receiveChk = this
//				.down('#receiveChk');
//
//		// Ensure that at least one of the send and receive checkboxes are
//		// always checked
...
//			this.setupFocus(this.down('#nameField').getFocusEl(), this.down(
//					'#cancel').getFocusEl());
//		});
//	}
//});
