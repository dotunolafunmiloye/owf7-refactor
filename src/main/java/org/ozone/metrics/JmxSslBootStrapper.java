...
/**
 * Sets up an ssl protected RMI/JMX server on a given port.
 * <p>
 * Any java tool (such as jconsole) connecting to this port should set system properties
 * <code><pre>
 *   javax.net.ssl.keystore=client_keystore.jks 
 *   javax.net.ssl.keyStorePassword=password 
 *   javax.net.ssl.keyStoreType=JKS 
 *   javax.net.ssl.trustStore=rootca.jks
 * </pre></code>
 * For JConsole:<p>
 * <code> 
 *   jconsole -J-Djavax.net.ssl.keystore=client_keystore.jks -J-Djavax.net.ssl.keyStorePassword=password -J-Djavax.net.ssl.keyStoreType=JKS -J-Djavax.net.ssl.trustStore=rootca.jks
 * </code>
 */
