...
class TestUtil extends GrailsUnitTestCase{
	...
	static void assertInListProperty(property, domainEntity) {
		assertEqualsConstraintCode(ConstrainedProperty.IN_LIST_CONSTRAINT, property, domainEntity)
	}

	static void assertBlankProperty(property, domainEntity) {
		assertEqualsConstraintCode(ConstrainedProperty.BLANK_CONSTRAINT, property, domainEntity)
	}
